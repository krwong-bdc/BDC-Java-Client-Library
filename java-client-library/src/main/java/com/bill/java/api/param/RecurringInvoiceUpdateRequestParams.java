...
/**
 * Parameters for updating a RecurringInvoice through the BDC API
 */
public class RecurringInvoiceUpdateRequestParams extends ApiResourceParams {
    /* Holds the actual api resource variables for creation */
    @SerializedName("obj")
    protected final Params params;

    private RecurringInvoiceUpdateRequestParams(Params params) { this.params = params; }

    /**
     * Makes a new Builder for RecurringInvoiceUpdateRequestParams
     *
     * @return a builder for RecurringInvoiceUpdateRequestParams
     */
    public static Builder builder() { return new Builder(); }

    /**
     * Builds an RecurringInvoiceUpdateRequestParams instance
     */
    public static class Builder {
        ...
        /**
         * Builds an RecurringInvoiceUpdateRequestParams instance with the set parameters.
         *
         * @return RecurringInvoiceUpdateRequestParams
         */
        public RecurringInvoiceUpdateRequestParams build() {
            return new RecurringInvoiceUpdateRequestParams(
                    new Params(
                            id,
                            isActive,
                            customerId,
