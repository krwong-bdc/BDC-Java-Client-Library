...
/**
 * Parameters for creating an Invoice through the BDC API
 */
public class InvoiceCreateRequestParams extends ApiResourceParams {
    /* Holds the actual api resource variables for creation */
    @SerializedName("obj")
    protected final Params params;

    private InvoiceCreateRequestParams(Params params) { this.params = params; }

    /**
     * Makes a new Builder for InvoiceCreateRequestParams
     *
     * @return a builder for InvoiceCreateRequestParams
     */
    public static Builder builder() { return new Builder(); }

    /**
     * Builds a InvoiceCreateRequestParams object
     */
    public static class Builder {
        ...
        /**
         * Builds an InvoiceCreateRequestParams instance with the set parameters.
         *
         * @return InvoiceCreateRequestParams
         */
        public InvoiceCreateRequestParams build() {
            return new InvoiceCreateRequestParams(
                    new Params(
                            isActive,
                            customerId,
                            invoiceNumber,
